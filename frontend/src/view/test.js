import { TweenLite, TimelineMax, Back, Power1, Linear } from "gsap";
// TimelineMax
...
listTl
  ...
  .to(
    [btnBg, btnLabel],
    0.15,
    { scaleY: 0.95, ease: Power1.easeInOut, repeat: 1, yoyo: true },
    0.5
  );
...
truckTl
  ...
  .fromTo(
    ...
    1.2,
    { x: 0 },
    { x: "+=1000", ease: Back.easeIn.config(0.5) },
    1.4
  )
  .fromTo(
    truckBtn,
...
function getClickCoords(e) {
  var svgRect = document.querySelector("#ship-it").getBoundingClientRect(),
    btnRect = document
      .querySelector("[data-anim=btn-bg]")
